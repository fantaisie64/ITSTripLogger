...
//    [[UIApplication sharedApplication] scheduleLocalNotification:localNotification];
    ...
    //In ViewDidLoad important in iOS8!
    if(IS_OS_8_OR_LATER) {
        [iTSBeaconManager.locationManager requestAlwaysAuthorization];
    }
...
//    self.navigationItem.leftBarButtonItem=newBackButton;
    ...
    signedIn = NO;
    offlineLogin = NO; //for offline sign out bug
    //test connection
