...
@synthesize iTSSignInDelegate, iTSBeaconDelegate, iTSConnectionManager, locationManager, beacons, iTSCars;
@synthesize rssiThresholdValue, rssiToleranceValue, locationServiceEnabled;
            ...
            if(!gotBeaconBoolean){
                ...
                if(b.rssi > (tempBeaconThresholdValue+tempBeaconToleranceValue)){
                    ...
                    if(tempCount >= sensingCount){
                        ...
                        [self saveTypePlist];
                        if(gotBeaconName != nil && gotBeaconName != (id)[NSNull null] && ![gotBeaconName isEqualToString:@""]){
...
-(void) saveTypePlist {
    if(typePlistDict != nil){
        if(gotBeaconBoolean){
            ...
            [typePlistDict removeAllObjects];
            [typePlistDict setObject:[NSNumber numberWithBool:gotBeaconBoolean] forKey:@"type"];
        }
...
-(void) loadParameterPlist{
    ...
    if([parameterPlistDict objectForKey:@"locationServiceEnabled"] != nil)
        locationServiceEnabled = [[parameterPlistDict objectForKey:@"locationServiceEnabled"] boolValue];
...
-(void) saveParameterPlist{
    if(parameterPlistDict != nil){
        ...
        [parameterPlistDict setObject:[NSNumber numberWithBool:locationServiceEnabled] forKey:@"locationServiceEnabled"];
...
-(void) clearCarData{
    if(gotBeaconBoolean){
            if(gotBeaconName != nil && gotBeaconName != (id)[NSNull null] && ![gotBeaconName isEqualToString:@""]){
                NSLog(@"Left Car3 %@", gotBeaconName);
                if(iTSSignInDelegate != nil && iTSSignInDelegate.mainTabBarViewController != nil)
                    iTSSignInDelegate.mainTabBarViewController.title = @"";
            }else{
                NSLog(@"Left Car3 %@,%@", gotBeaconMajor, gotBeaconMinor);
                if(iTSSignInDelegate != nil && iTSSignInDelegate.mainTabBarViewController != nil)
                    iTSSignInDelegate.mainTabBarViewController.title = @"";
            }
            NSInteger tempRssi = 0;
            //workaround
            if(gotBeacon != nil)
                tempRssi = (NSInteger) gotBeacon.rssi;
            [self uploadRecordDataWithType:TypeEnd Rssi:tempRssi UUID:gotBeaconUUID Major:gotBeaconMajor Minor:gotBeaconMinor Name:gotBeaconName];
            gotBeaconBoolean = NO;
            gotBeacon = nil;
            gotBeaconUUID = nil;
            gotBeaconMajor = nil;
