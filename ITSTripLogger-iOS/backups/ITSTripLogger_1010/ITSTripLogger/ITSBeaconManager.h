...
@interface ITSBeaconManager : NSObject <CLLocationManagerDelegate>{
    ...
    NSInteger gotBeaconThresholdValue;
    NSInteger gotBeaconToleranceValue;
    ...
    BOOL testBeaconMode;
    int testBeaconCountThreshold;
    float testBeaconCount;
    NSNumber *testBeaconMajor;
    NSNumber *testBeaconMinor;
    float testBeaconRssiValue;
}
...
- (void) testBeaconRSSIMajor:(NSNumber *)testBeaconMajor Minor:(NSNumber *)testBeaconMinor;
